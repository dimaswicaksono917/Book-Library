...
@section('title', 'Return Borrowing')
@section('page-title', 'Return Borrowing')
...
@section('breadcrumb')
    ...
    <div class="breadcrumb-item active">Return </div>
@endsection

@section('content')
    <div class="card">
        <div class="card-header bg-primary">
            <h4 class="m-b-0 text-white">Form Return Borrowing</h4>
        </div>

        <div class="card-body">
            <form class="form" role="form" method="POST" action="{{ route('history.return.save') }}
            "
