...
@section('title', 'User Inactive')
@section('page-title', 'User Inactive')
...
@section('breadcrumb')
    <div class="breadcrumb-item">User Inactive</div>
...
@section('content')
    ...
    <section>
        <div class="card">
            <div class="card-body">
                <a href="{{route('user.index')}}" class="btn btn-orange float-right mb-4"><i class="fa fa-plus-info"></i>See active user</a>
